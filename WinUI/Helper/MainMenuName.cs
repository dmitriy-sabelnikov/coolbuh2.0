...
namespace WinUI.Helper
{
    ...
    {                                                                    
        ...
        public static string RefTypeAddAccr    = "RefTypeAddAccr";    //1.1.7  Справочник дополнительных типов начислений
        public static string RefTypeAddPayment = "RefTypeAddPayment"; //1.1.8  Справочник типов дополнительных выплат
        public static string RefMinSalary      = "RefMinSalary";      //1.1.9  Справочник минимальная зп
        public static string RefLivWage        = "RefLivWage";        //1.1.10  Справочник прожиточный минимум
        public static string RefSocBenefit     = "RefSocBenefit";     //1.1.11  Справочник социальная льготы
        //================================
        ...
        public static string AddAccr           = "AddAccr";           //1.4.5  Дополнительные начисления
        public static string IncTax            = "IncTax";            //1.4.6  Корректировка подоходного налога
        //================================                            
        public static string Рaying            = "Рaying";            //1.5.   Выплаты(платежи)
        public static string Payment           = "Payment";           //1.5.1  Выплаты
        public static string AddPayment        = "AddPayment";        //1.5.2  Дополнительные выплаты
        //================================                            
        public static string Reports           = "Reports";           //1.6.   Отчеты
