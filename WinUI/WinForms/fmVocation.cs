...
namespace WinUI.WinForms
{
    public partial class fmVocation : Form
    {
        ...
        private List<v_Vocation> _vVocations = new List<v_Vocation>(); //кэш
        ...
        private void RefreshTableVocation(int depId, DateTime dtBeg, DateTime dtEnd)
        {
            ...
            dgvVocation.StoreSort();
            LoadDataToGridVocation(0, depId, dtBeg, dtEnd);
            UpdateVocationResult();
            dgvVocation.RestSort<v_Vocation>();
        ...
        private void InitGridVocation()
        {
            ...
            dgvVocation.AddSortGrid<v_Vocation>("Vocation_Id");
            dgvVocation.AddSearchGrid();
            dgvVocation.AddStatusStripRow(statusStripRow, true);
        }
        ...
        private bool LoadDataToGridVocation(int vocationId, int depId, DateTime datBeg, DateTime datEnd)
        {
            ...
            if (error != string.Empty)
            {
                MessageBox.Show("Помилка завантаження відпускних.\nТехнічна інформація: " + error, "Помилка");
                return false;
            }
            ...
            BindingSource source = new BindingSource();
            _vVocations = GetViewVocations(_vocations, _persCards, _refDeps);
            source.DataSource = _vVocations;
        ...
        private void UpdateVocationResult()
        {
            StatTotDays.Text = "Всього дні: " + _vVocations.Sum(rec => rec.Vocation_Days).ToString();
            StatTotSm.Text = "Всього сума: " + _vVocations.Sum(rec => rec.Vocation_Sm).ToString() + " грн.";
        }
        ...
        private void fmVocation_KeyDown(object sender, KeyEventArgs e)
        {
